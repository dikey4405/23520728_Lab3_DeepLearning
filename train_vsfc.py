...
if __name__ == "__main__":
    ...
    vocab = Vocab(path="D:\\Python\\Nam3\\DL\\ThucHanh\\Lab3\\\\uit_vsfc")
    logging.info("Loading dataset ... ")

    train_dataset = UIT_VSFC(
        "D:\\Python\\Nam3\\DL\\ThucHanh\\Lab3\\uit_vsfc\\UIT-VSFC-train.json",
        vocab=vocab
    )

    dev_dataset = UIT_VSFC(
        "D:\\Python\\Nam3\\DL\\ThucHanh\\Lab3\\uit_vsfc\\UIT-VSFC-dev.json",
        vocab=vocab
    )

    test_dataset = UIT_VSFC(
        "D:\\Python\\Nam3\\DL\\ThucHanh\\Lab3\\uit_vsfc\\UIT-VSFC-test.json",
        vocab=vocab
    )
